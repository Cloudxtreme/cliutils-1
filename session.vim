...
noremap <silent> <Down> :cn
noremap <silent> <Up> :cp
noremap <silent> <Right> :bn
noremap <silent> <Left> :bp
nmap <silent> <F6> :sp ~/cliutils/data/uskeyboard.txt:resize 12gg
nmap <silent> <F5> :!ctags -R --exclude=.svn --exclude=.git --exclude=log *
nmap <silent> <F4> :TagbarToggle
nmap <silent> <F3> :NERDTreeToggle
nmap <silent> <F2> :GundoToggle
cnoremap  <Home>
cnoremap  <End>
...
imap  <Plug>TComment_
map ó :mksession! session.vim
cabbr gitv =(getcmdtype()==':' && getcmdpos()==1 ? 'Gitv' : 'gitv')
iabbr _time =strftime("%H:%M:%S")
iabbr _date =strftime("%d/%m/%y")
iabbr _datetime =strftime("%d/%m/%y %H:%M:%S")
abbr _t; @TODO:
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/vim-addon-mw-utils/,~/.vim/plugged/vimshell.vim/,~/.vim/plugged/vim-colors-solarized/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-snipmate/,~/.vim/plugged/gitv/,~/.vim/plugged/vim-snippets/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/vim-easy-align/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/rainbow_parentheses.vim/,~/.vim/plugged/colorizer/,~/.vim/plugged/tagbar/,~/.vim/plugged/emmet-vim/,~/.vim/plugged/tabline.vim/,~/.vim/plugged/nerdtree/,~/.vim/plugged/syntastic/,~/.vim/plugged/vim-polyglot/,~/.vim/plugged/gundo.vim/,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/tlib_vim/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/vim-surround/,~/.vim/plugged/bash-support.vim/,~/.vim/plugged/vim-expand-region/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/vim-snipmate/after,~/.vim/plugged/vim-polyglot/after,~/.vim/after
set shell=/bin/sh
set shiftround
set shiftwidth=4
set smartcase
...
set shortmess=aoO
badd +1 utils/updateutils
badd +1 utils/updateutils.py
badd +6 utils/updaterepos
badd +1 data/links.db
args utils/updateutils utils/updateutils.py
edit data/links.db
